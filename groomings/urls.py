...
urlpatterns = [
    ...
    path(r'anyms/', views.anyms, name='anyms'), # 匿名質問一覧ページ(自分にきた質問と自分がした質問を一覧表示)
    path(r'question/<int:question_id>/', views.question_detail, name='question_detail'), # 秘密質問の詳細ページ(<int:question_id>必要)
